...
{text="Also, I can burrow underneath these rocks by pressing the right mouse button.",character=cutscene.renderPorcupine},{text=" It seems every shape has an action on both mousebuttons.",character=cutscene.renderPorcupine}}
